...
import { B as Block, S as StatusTracker, e as BlockLabel, O as Code$2, g as Empty, i as IconButton$1, H as Copy$1, D as Download$1, h as IconButtonWrapper$1 } from './2-B1kq23UX.js';
...
const lang_map = {
  python: () => import('./index27-DKPcPUdx.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index28-Bf6UaSpV.js'),
      import('./frontmatter-RQdhduVb.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index32-CNeW1qP0.js').then((m) => m.json()),
  html: () => import('./index29-DvFj7xJU.js').then((m) => m.html()),
  css: () => import('./index30-BDPMLKuO.js').then((m) => m.css()),
  javascript: () => import('./index31-CA1nmcUD.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index31-CA1nmcUD.js').then(
...
//# sourceMappingURL=Index13-CaypV8ks.js.map
